    ...
    return (
        <div>
            <div className="card-body">
                ...
                <h1 className="m-2">{data.name} | {data.sys.country}</h1>
                <div className="data m-1">{timeConverter(data.dt)}</div>
                <div className="description">
                    <img className="data-img m-2" src={`http://openweathermap.org/img/w/${data.weather[0].icon}.png`}/>
                   ...
                   <div className="data m-2">Wind speed: {data.wind.speed} miles/hour</div>
